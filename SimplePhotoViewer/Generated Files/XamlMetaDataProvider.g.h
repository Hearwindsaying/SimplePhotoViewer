...
struct WINRT_EBO XamlMetaDataProvider_base : implements<D, Windows::UI::Xaml::Markup::IXamlMetadataProvider, I...>
{
    ...
    using class_type = SimplePhotoViewer::XamlMetaDataProvider;
    ...
    {
        return L"SimplePhotoViewer.XamlMetaDataProvider";
    }
};
...
{
    using instance_type = SimplePhotoViewer::XamlMetaDataProvider;
