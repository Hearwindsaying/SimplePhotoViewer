...
struct WINRT_EBO DetailPage_base : implements<D, SimplePhotoViewer::IDetailPage, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::Controls::IPageOverrides, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, composing, I...>,
...
{
    using base_type = DetailPage_base;
    using class_type = SimplePhotoViewer::DetailPage;
    using implements_type = typename DetailPage_base::implements_type;
    ...
    {
        return L"SimplePhotoViewer.DetailPage";
    }
    DetailPage_base()
    {
...
struct WINRT_EBO DetailPageT : implements<D, Windows::Foundation::IActivationFactory, I...>
{
    using instance_type = SimplePhotoViewer::DetailPage;
...
#if defined(WINRT_FORCE_INCLUDE_DETAILPAGE_XAML_G_H) || __has_include("DetailPage.xaml.g.h")

#include "DetailPage.xaml.g.h"
...
{
    template <typename D, typename... I>
    using DetailPageT = DetailPage_base<D, I...>;
}
