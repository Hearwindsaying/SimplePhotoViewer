...
struct WINRT_EBO BackdropBlurBrush_base : implements<D, SimplePhotoViewer::IBackdropBlurBrush, Windows::UI::Xaml::Media::IBrushOverrides2, Windows::UI::Xaml::Media::IXamlCompositionBrushBaseOverrides, composing, I...>,
...
{
    using base_type = BackdropBlurBrush_base;
    using class_type = SimplePhotoViewer::BackdropBlurBrush;
    using implements_type = typename BackdropBlurBrush_base::implements_type;
    ...
    {
        return L"SimplePhotoViewer.BackdropBlurBrush";
    }
    BackdropBlurBrush_base()
    {
...
struct WINRT_EBO BackdropBlurBrushT : implements<D, Windows::Foundation::IActivationFactory, SimplePhotoViewer::IBackdropBlurBrushStatics, I...>
{
    using instance_type = SimplePhotoViewer::BackdropBlurBrush;
    ...
    Windows::UI::Xaml::DependencyProperty BlurAmountProperty()
    {
        return T::BlurAmountProperty();
    }
};

}

#if defined(WINRT_FORCE_INCLUDE_BACKDROPBLURBRUSH_XAML_G_H) || __has_include("BackdropBlurBrush.xaml.g.h")

#include "BackdropBlurBrush.xaml.g.h"
...
{
    template <typename D, typename... I>
    using BackdropBlurBrushT = BackdropBlurBrush_base<D, I...>;
}
