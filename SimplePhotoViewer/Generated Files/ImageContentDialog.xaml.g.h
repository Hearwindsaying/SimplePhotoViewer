...
namespace winrt::SimplePhotoViewer::implementation
{
    ...
    struct ImageContentDialogT : public ::winrt::SimplePhotoViewer::implementation::ImageContentDialog_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename ImageContentDialogT::base_type;
        using base_type::base_type;
        using class_type = typename ImageContentDialogT::class_type;
